      ...
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          <p className="text-lg font-bold text-gray-900 mb-1">
            See how Nudgify compares to Appcues, Pendo, and DIY
          </p>
          <p className="text-sm text-gray-500">
            Pricing, features, and an honest breakdown of who each tool is built for.
          </p>
        </div>
        <Link
          href="/compare"
          className="shrink-0 inline-flex items-center gap-2 bg-[#4f6ef7] text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#3b5af5] transition-colors shadow-sm shadow-blue-200 whitespace-nowrap"
        >
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-6">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/compare" className="text-sm text-gray-400 hover:text-gray-700 transition-colors">
              Compare
            </Link>
            <Link href="/docs" className="text-sm text-gray-400 hover:text-gray-700 transition-colors">
              Docs
            </Link>
            <Link href="/#pricing" className="text-sm text-gray-400 hover:text-gray-700 transition-colors">
              Pricing
            </Link>
